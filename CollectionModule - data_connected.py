...
def get_data_from_excel():
        df = pd.read_excel(io="C:/Users/Amani Reddy/Dashboards/files_updated/files/A_Score_amani.xlsx",engine="openpyxl")
        return df
...
if selected_option=='Borrower Profile':
    ...
    if(Collection_Priority=='High_Risk'):
        ...
        Collection_Priority_color="yellow"
    else:
    ...
    if(Collection_Action_pre_EMI=='Digital'):
        ...
        Collection_Action_pre_EMI_color="yellow"
    else:
    ...
    if(Collection_Action_post_EMI=='Digital + Calling(after 5 days)'):
        ...
        Collection_Action_post_EMI_color="yellow"
    else:
    ...
    if(loans_open_last_6m<=1):
        ...
        loans_open_last_6m_color="yellow"
    else:
    ...
    if(last_12m_max_dpd_all_prods<=29):
        ...
        last_12m_max_dpd_all_prods_color="yellow"
    else:
    ...
    table_2=f'''
            ...
            <td >INR 60000</td>
            <td><font color='black'>Good</font></td></tr>
    ...
    summary = {"title": {
        ...
        "legend":{"data":["% of population in P1","% of population in P2","% of population in P3","AUM"],'backgroundColor':'white'},
      ...
      "series": [
        {
         "name":"AUM",
          "data":[{ "value": int(p1_perc_population)+30, "itemStyle": {"borderWidth": 4,
                                                "borderColor": '#82eefd',
                                                "color": 'white'},"label": {"show": True,
                                                                        "position": 'inside',
                                                                        "formatter":str(p1_AUM)+" Cr"}},
                { "value": int(p2_perc_population)+30, "itemStyle": {"borderWidth": 4,
                                                "borderColor": '#63c5da',
                                                "color": 'white'},"label": {"show": True,
                                                                        "position": 'inside',
                                                                        "formatter":str(p2_AUM)+" Cr"} },
                { "value":int(p3_perc_population)+30, "itemStyle": { "borderWidth": 4,
                                                "borderColor": '#63c5da',
                                                "color": 'white'},"label": {"show": True,
                                                                        "position": 'inside',
        ...
        {"name":["% of population in P1","% of population in P2","% of population in P3"],
                "data":[{"name":"% of population in P1","value": int(p1_perc_population), "itemStyle": { "color": "red" } },
                {"name":"% of population in P2", "value": int(p2_perc_population), "itemStyle": { "color": 'yellow' } },
                {"name":"% of population in P3", "value": int(p3_perc_population), "itemStyle": { "color": 'green' } }],
                "type": 'bar',
                "barWidth":80,
                "color":'skyblue',
                "label": {
      ...
      "series": [
        {
          ...
          "type": 'pie',
          "radius": '60%',
          "data":sorted(create_data_for_pie(['digital','Calling','Field'],[100,52,25]),key=lambda x:x['value']),
          "emphasis": {
            "itemStyle": {
              "shadowBlur": 10,
              "shadowOffsetX": 0,
